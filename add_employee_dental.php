...
$sql="select * from nua_monthly_member_census where month_id = '" . $post['month_id'] . "' and client_plan = '" . $post['client_plan'] . "' and employee_id = " . $post['employee_id']; 
$r=$X->sql($sql);
if (sizeof($r)==0) $X->post($post);
}
?>
