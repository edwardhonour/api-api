...
case 'submit-quote':
        ...
        break;	
		case 'post-forward-census':
                $output=$F->postForwardCensus($data);
                break;
		case 'flip-myna':
                $output=$F->flipMyna($data);
                break;
		case 'flip-ready':
                $output=$F->flipReady($data);
                break;
		case 'post-census-bad':
                $output=$F->postCensusBad($data);
                break;
		case 'delete-adjustment':
                $output=$F->deleteAdjustment($data);
                break;
		case 'company-invoice':
                $output=$F->getCompanyInvoice($data);
                break;
		case 'post-add-employee-census':
                $output=$F->postAddEmployeeSmall($data);
                break;
		case 'add-broker':
		...
		case 'duplicate-employees':
                ...
                break;	
		case 'fix-employee-price':
                $output=$F->fixEmployeePrice($data);
                break;	
		case 'delete-duplicate-employee':
                $output=$F->deleteDuplicateEmployees($data);
                break;	
		...
		case 'system-note-list':
                ...
                break;	
		case 'add-system-note':
                $output=$F->getAddSystemNote($data);
                break;	
		case 'system-note-dashboard':
                $output=$F->getSystemNoteDashboard($data);
                break;	
		case 'post-system-note':
                $output=$F->postSystemNote($data);
                break;	
		case 'post-inactivate-plan':
                $output=$F->postInactivatePlan($data);
                break;	
        ...
        case 'current-census':
                ...
                break;
        case 'peo-company-list':
                $output=$F->getPeoCompanyList($data);
                break;
        ...
        case 'current-additions':
                ...
                break;
        case 'active-plans':
                $output=$F->getActivePlans($data);
                break;
        case 'nuaxess-home':
                $output=$F->getNuAxessDashboard($data);
                break;
        case 'badmin':
        ...
        case 'post-enroll':
                ...
                break;
        case 'post-update-census':
                $output=$F->postUpdateCensus($data);
                break;
        case 'post-edit-plan':
	    ...
	    case 'previous':
			   ...
			   break;
	//Adds
	case 'post-census-move':
               $output=$F->postEmployeeMove($data);
               break;
        case 'add-org':
	...
	//Post Adds				
        ...
        case 'org-dashboard':
                ...
                break;
        case 'census-dashboard':
                $output=$F->getCensusDashboard($data);
                break;
        case 'company-fix':
                $output=$F->getCompanyFix($data);
                break;
        ...
        case 'org-list':
                ...
                break;
        case 'vendor-list':
                $output=$F->getVendorList($data);
                break;
        case 'edit-vendor':
                $output=$F->getEditVendor($data);
                break;
        case 'company-list':
        ...
        case 'post-edit-employee':
                ...
                break;				
        case 'post-edit-vendor':
                $output=$F->postEditVendor($data);
                break;				
        case 'post-add-level':
